...
<template>
  <div>
    <input v-model="tonerType" id="toner type" type="text" placeholder="toner type" />
    <input v-model="quantity" id="quantity" type="text" placeholder="quantity" />
    <input v-model="location" id="location" type="text" placeholder="location" />
